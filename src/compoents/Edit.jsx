...
const Edit = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} 
          className='w-96 mx-auto mt-20 border-2 rounded p-5 shadow-lg'>

      <h1 className='text-gray-500 font-bold text-2xl mb-6'>Edit Contact</h1>
      ...
      <button type='submit' className='bg-green-800 py-2 px-4 text-sm my-5 uppercase text-white rounded shadow-lg'>
        edit
      </button>
